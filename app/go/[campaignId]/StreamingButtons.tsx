...
export function SoundCloudButton({ href, songTitle, artistName }: { href: string; songTitle: string; artistName: string }) {
  return (
    <a href={href} onClick={() => firePixel('soundcloud', songTitle, artistName)}
      className="flex items-center justify-center gap-3 w-full bg-gray-800/80 hover:bg-gray-700/80 border border-gray-700/50 backdrop-blur text-white font-semibold py-4 px-6 rounded-xl transition">
      <SoundCloudIcon />
      SoundCloud
    </a>
...
function SoundCloudIcon() {
  return (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      <path d="M1.175 12.225c-.051 0-.094.046-.101.1l-.233 2.154.233 2.105c.007.058.05.098.101.098.05 0 .09-.04.099-.098l.264-2.105-.264-2.154c-.009-.055-.049-.1-.099-.1m-.899.828c-.06 0-.091.037-.104.094L0 14.479l.165 1.308c.014.06.045.094.09.094s.089-.033.104-.094l.21-1.308-.21-1.332c-.015-.057-.045-.094-.09-.094m1.83-1.229c-.061 0-.12.045-.12.104l-.21 2.563.225 2.458c0 .06.045.104.119.104.061 0 .105-.044.121-.104l.254-2.458-.254-2.563c-.016-.06-.061-.104-.121-.104m.945-.089c-.075 0-.135.06-.15.135l-.193 2.523.21 2.443c.016.077.075.138.149.138.075 0 .135-.061.15-.15l.24-2.431-.24-2.512c-.015-.075-.075-.135-.15-.135m1.155.36c-.005-.09-.075-.149-.159-.149-.09 0-.158.06-.164.149l-.217 2.288.202 2.443c0 .09.075.157.159.157.09 0 .158-.068.164-.157l.23-2.443-.215-2.288zm.809-1.709c-.101 0-.18.09-.18.181l-.21 3.957.187 2.417c0 .09.08.164.18.164.096 0 .18-.075.18-.18l.209-2.401-.209-3.957c0-.09-.084-.181-.18-.181m.959-.914c-.105 0-.195.09-.203.194l-.18 4.872.165 2.406c0 .09.09.18.195.18.104 0 .194-.09.194-.18l.196-2.406-.196-4.872c0-.104-.09-.194-.194-.194m1.032.045c-.115 0-.21.09-.21.21l-.165 4.827.165 2.397c0 .12.09.21.21.21.114 0 .21-.09.21-.21l.18-2.397-.18-4.827c0-.12-.09-.21-.21-.21m1.155.6c-.121 0-.225.104-.225.225l-.15 4.212.15 2.373c0 .135.104.24.225.24.135 0 .24-.105.24-.24l.164-2.373-.164-4.212c0-.135-.105-.225-.24-.225m1.184-.045c-.135 0-.24.104-.24.24l-.135 4.257.135 2.362c0 .135.105.24.24.24.135 0 .24-.105.24-.24l.15-2.362-.15-4.257c0-.135-.105-.24-.24-.24m1.2.72c-.15 0-.255.12-.255.255l-.12 3.537.12 2.347c0 .15.105.271.255.271.135 0 .255-.121.255-.271l.135-2.347-.135-3.537c0-.135-.12-.255-.255-.255m2.31-.884c-.045-.03-.104-.045-.164-.045-.061 0-.121.015-.166.045-.09.045-.149.135-.149.24v.015l-.104 6.106.104 2.257c.016.164.15.284.315.284.164 0 .299-.12.299-.284l.121-2.257-.121-6.121c0-.104-.06-.194-.135-.24m1.005-.375c-.045-.03-.105-.045-.166-.045-.074 0-.135.015-.194.06-.075.045-.12.135-.12.226v.03l-.09 6.451.09 2.242c0 .18.15.33.33.33s.33-.15.33-.33l.104-2.242-.104-6.466c0-.12-.075-.209-.18-.256m9.239 3.239c-.405 0-.795.086-1.14.24-.24-2.7-2.52-4.816-5.294-4.816-.675 0-1.335.135-1.92.36-.225.09-.285.18-.285.359v9.912c0 .18.135.33.315.345h8.324c1.65 0 2.985-1.335 2.985-2.985 0-1.665-1.335-3-2.985-3z" />
    </svg>
  );
}
