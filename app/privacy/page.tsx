  ...
  return (
    <div className="max-w-3xl mx-auto py-12 space-y-8 text-gray-300">
      ...
      <section className="space-y-3">
        ...
        <p>
          Hypewave ("we", "us", "our") is an automated music promotion platform that helps artists
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          <a href="mailto:privacy@hypewave.app" className="text-blue-400 hover:underline">
            privacy@hypewave.app
          </a>.
        </p>
      </section>
    </div>
